...
/**
 * TwitterController
 * Implements the TweetMiner app using Twitter's API
 * Extracted the information from https://www.playframework.com/documentation/2.6.x/JavaOAuth
 * Used java OAuth to interact with Twitter Protected data and by using the consumer access keys.
...
public class TwitterController extends Controller {
    ...
    /**
     * Constructor.
     * injects all the dependencies we need
     * @param wsclient WSClient to query the API
     * @param formFactory  FormFactory
     * @param cache SyncCacheApi
     * @param ec HttpExecutionContext
     */
    @Inject
    public TwitterController(WSClient wsclient, final FormFactory formFactory, SyncCacheApi cache, HttpExecutionContext ec) {
    ...
    {
        return wsclient.url(baseUrl + "/search/tweets.json")
    ...
    {
        return wsclient.url(baseUrl + "/statuses/user_timeline.json")
                .addQueryParameter("count", "10")
                .addQueryParameter("tweet_mode", "extended")
